...
class RoopInputMsgV2(_message.Message):
    __slots__ = ("sources", "target", "processor", "reference_face_position", "dest")
    ...
    reference_face_position: int
    dest: str
    def __init__(self, sources: _Optional[_Iterable[str]] = ..., target: _Optional[str] = ..., processor: _Optional[str] = ..., reference_face_position: _Optional[int] = ..., dest: _Optional[str] = ...) -> None: ...
